...
//$scope, $state, $http, $location, $window, Authentication
angular.module('auxthera',['ui.bootstrap']).controller('auxtheraController', ['$scope', '$state', '$http', '$window', 'Authentication', '$location', '$stateParams', 'ActivePatient', 'PracticesService', '$sce',
